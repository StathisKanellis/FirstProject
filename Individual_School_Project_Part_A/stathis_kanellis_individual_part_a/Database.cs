...
namespace stathis_kanellis_individual_part_a
{
    class Database
    {
        ...
        public Database()
        {
            ...
            List<Student> studs1 = new List<Student>() { };
            ...
            coursePerAssignments = new List<CoursePerAssignments>() { CRA1, CRA2, CRA3 };
            ...
            AssignmentsPerStudent SPCPA9 = new AssignmentsPerStudent(st1, assign5);
            ...
            assignmentsPerStudent = new List<AssignmentsPerStudent>() { SPCPA1, SPCPA2, SPCPA3, SPCPA4, SPCPA5, SPCPA6, SPCPA7, SPCPA8, SPCPA9, SPCPA1 };
