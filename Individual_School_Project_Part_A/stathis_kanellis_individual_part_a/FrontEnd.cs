...
namespace stathis_kanellis_individual_part_a
{
    class FrontEnd
    {
        ...
        private static Course InputDataCourse()
        {
            ...
            {
                Console.WriteLine("Give Start Date Course (y/m/d): ");
            }
            DateTime endDate;
            while (!DateTime.TryParse(Console.ReadLine(), out endDate))
            {
                Console.WriteLine("Give End Date Course (y/m/d): ");
            }
        ...
        private static Student InputDataStudent()
        {
            ...
            Console.WriteLine("Give Last Name: ");
            string lastname = Console.ReadLine();
            Console.WriteLine("Give Birthday (y/m/d): ");
            DateTime birth;
            while (!DateTime.TryParse(Console.ReadLine(), out birth))
            {
                Console.WriteLine("Please input date to check (y/m/d): ");
            }
            int tuitionFees;
        ...
        private static Assignment InputDataAssignment()
        {
            ...
            Console.WriteLine("Give Submission Assignment (y/m/d): ");
            DateTime subTime;
